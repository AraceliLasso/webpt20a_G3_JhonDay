...
export const seedProducts = async (dataSource: DataSource) => {
    ...
    const products = [
        ...
        },
        {
            ...
            description: "Servicio de reparacion para impresoras que trabajan con sistema de cartuchos.",
            price: 10.00,
        ...
        },
        {
            ...
            description: "Servicio de reparacion de lineas telefonicas.",
            price: 10.00,
        ...
        },
        {
            ...
            description: "SIGESMED es una herramienta utilizada en el ambito de la salud publica para gestionar y monitorear la atencion de personas con problemas de salud mental y/o consumo de drogas.",
            price: 10.00,
        ...
        },
        {
            ...
            name: "Profesional capacitado en administracion escolar",
        ...
        },
        {
            ...
            name: "Reparacion de Impresoras laser",
            description: "Servicio de revision, configuracion y reparacion para impresoras que utilizan un toner en polvo y un laser para crear imagenes y textos en el papel.",
            price: 10.00,
